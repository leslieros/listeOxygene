...
import { Post } from '../blog-engine-page/Post';
...
export class ActualitiesComponent {
  posts: Array<Post> = [
    {
      auteur: 'Leslie',
      article: 'In his tractibus navigerum nusquam visitur flumen sed in locis plurimis aquae suapte natura calentes emergunt ad usus aptae multiplicium medelarum. verum has quoque regiones pari sorte Pompeius Iudaeis domitis et Hierosolymis captis in provinciae speciem delata iuris dictione formavit,'+
      ...
      date: new Date('07/12/2019').toDateString(),
      position: 0,
      titre: 'Lorem ipsum',
      lien: 'https://www.faux-texte.com/lorem-ipsum-3.htm'
    },
    {
      auteur: 'Leslie',
      article: 'In his tractibus navigerum nusquam visitur flumen sed in locis plurimis aquae suapte natura calentes emergunt ad usus aptae multiplicium medelarum. verum has quoque regiones pari sorte Pompeius Iudaeis domitis et Hierosolymis captis in provinciae speciem delata iuris dictione formavit,'+
